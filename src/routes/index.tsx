        ...
        <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-brand via-brand to-brand/90 text-brand-foreground">
          ...
          <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 py-20 text-center md:py-28">
            ...
            <h1 className="max-w-4xl font-display text-4xl font-bold leading-[1.1] md:text-6xl">
              ...
              <span className="text-gold">Kattedan , Aramghar ,Jalpally , Sri Ram Colony & Surrounding areas</span>
            </h1>
              ...
              {[
                {
                  ...
                  title: "Browse & Filter",
                  body:
                    "Explore verified listings in Kattedan, Aramghar, Jalpally, Sri Ram Colony, Madhuban & surrounding areas with clear price, area, and facing details.",
                },
                {
                  n: "02",
                  icon: PhoneCall,
  ...
  return (
    <div className="rounded-2xl border border-dashed border-border p-16 text-center">
      ...
      <p className="mx-auto max-w-md text-sm text-muted-foreground">
        ...
        in Kattedan, Aramghar, Jalpally, Sri Ram Colony, Madhuban & surrounding areas.
      </p>
    </div>
  );
}
