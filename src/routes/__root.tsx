...
const TITLE = "GSK Enterprises — Verified Properties in Kattedan & Sri Ram Colony";
const DESC =
  "GSK Enterprises: trusted real estate mediator in Kattedan and Sri Ram Colony, Hyderabad. Open plots, houses, and land for sale or rent. Call or WhatsApp us direct.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "GSK Enterprises" },
